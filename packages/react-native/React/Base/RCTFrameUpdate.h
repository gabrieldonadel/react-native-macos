...
@class RCTPlatformDisplayLink;  // [macOS] RCTPlatformDisplayLink; an alias for CADisplayLink off macOS
...
- (instancetype)initWithDisplayLink:(RCTPlatformDisplayLink *)displayLink NS_DESIGNATED_INITIALIZER;  // [macOS] RCTPlatformDisplayLink; an alias for CADisplayLink off macOS
